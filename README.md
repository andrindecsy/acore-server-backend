...
- **Serialization:** JSON (System.Text.Json, automatic via Results.Ok)
- **Async/Concurrency:** async/await, Task\<T>
- **Build/Package Management:** dotnet CLI, NuGet
- **Deployment:** systemd service, Linux (Debian13)
- **API Protocol:** HTTP/REST, JSON request/response
